            ...
            <div class="container">
              ...
              <form  action="client_card.php" method="post" >
                <table class="table table-condensed">
                    ...
                    <tbody>
                         <tr>
                          <th> <label for="client_name"> Company Name</label> </th>
                          <th> <input type="text" class="form-control" name="client_name" id="client_name" placeholder="Enter Company Name "> </th>
